...
export PATH=$PATH:/home/ignacs/usrbin
export EDITOR=vim
# PS1="\h: [\w]$ "
# export PS1="\[\e[32;0m\]\u@\h<\!> [\w]>\j [\A]\\$ \[\e[0m\]"

#PS1='\[\033[01;33m\]\n[\w]\n${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u@\h\[\033[00m\]:\[\033[01;36m\]\W\[\033[00m\]\ $ '
#PS1='\[\033[01;33m\]\n[\w]\n\!:${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u@\h\[\033[00m\]:\[\033[01;36m\]\W\[\033[00m\] \j[\A]$ '
PS1='\[\033[01;33m\]\n[\w]\n\[\033[35m\]\!\[\033[00m\]:${debian_chroot:+($debian_chroot)} \j\[\033[01;32m\][$(date +%y/%m/%d)]\033[00m\][\A]@\h$      '
#PS1="\[\e[32;0m\]\u@\h<\!> [\w]>\j [\A]\\$ \[\e[0m\]"

# force tmux use 256 colors
